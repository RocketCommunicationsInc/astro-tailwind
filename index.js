...
const tokens = require('@astrouxds/tokens/dist/json/nested.json')
  ...
  },
  {
    theme: {
      ...
      fontSize: {
        ...
        "2xl": [
          "var(--font-size-2xl, 1.4375rem)",
          { lineHeight: "var(--line-height-tight, 1.25)" }
        ],
        "3xl": [
          "var(--font-size-3xl, 1.625rem)",
          { lineHeight: "var(--line-height-tight, 1.25)" }
        ],
        "4xl": [
          "var(--font-size-4xl, 1.8125rem)",
          { lineHeight: "var(--line-height-tight, 1.25)" }
        ],
        "5xl": ["var(--font-size-5xl, 2rem)", { lineHeight: "var(--line-height-tight, 1.25)" }],
        "6xl": ["var(--font-size-6xl, 2.25rem)", { lineHeight: "var(--line-height-tight, 1.25)" }]
      },
      // opacity: {
      //     0: "0",
      //     25: "var(--opacity-25)",
